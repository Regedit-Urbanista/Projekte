CREATE DATABASE Reparatur;
USE DATABASE Reparatur;
...
CREATE TABLE werkzeug (
  ...
  nameWerkzeug varchar(255) NOT NULL
   
);

CREATE TABLE personalien(
    personalienID int PRIMARY KEY AUTO_INCREMENT,
    name varchar(20),
    email varchar(50),
	...
	datum DATE,
	status BOOLEAN, 
    FK_werkzeugID int NOT NULL,
    FOREIGN KEY (FK_werkzeugID) REFERENCES werkzeug(WerkzeugID)
...
INSERT INTO werkzeug (WerkzeugID, nameWerkzeug) VALUES
(3, 'Abisolierzange'),
(4, 'Abflussspirale'),
(5, 'Abzieher'),
(6, 'Abziehstein'),
