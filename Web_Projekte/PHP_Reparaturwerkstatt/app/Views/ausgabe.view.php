...
<div class="container screenSize">
    <div class="card border-0 shadow my-5">
        <div class="card-body p-5">
            ...
            <p class="lead">Neue Aufträge <a href="form" class="btn btn-outline-secondary">Hinzufügen</a></p>
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $inhalt['personalienID']; ?>
                    </td>
                    <td>
                        <a href="bearbeiten?id=<?=$inhalt['personalienID'] ?>" class="btn btn-outline-dark">Bearbeiten</a>
                    </td>
                    <td>
                    ...
                    <td>
                        <?php echo $inhalt['telefonnummer']; ?>
                    </td>
                    <td>
                        <?php
                           if($inhalt['dringlichkeit'] == 0)
                            {
                                echo ('Sehr tief');
                            }
                            else if($inhalt['dringlichkeit'] == 1)
                            {
                                echo ('normal');
                            }
                            else if($inhalt['dringlichkeit'] == 2)
                            {
                                echo ('Tief');
                            }
                            else if($inhalt['dringlichkeit'] == 3)
                            {
                                echo ('Hoch');
                            }
                            else
        ...
        ?>
            ...
            $pdo = db();
            $statement = $pdo->prepare('SELECT * FROM personalien');
            $statement->execute();
