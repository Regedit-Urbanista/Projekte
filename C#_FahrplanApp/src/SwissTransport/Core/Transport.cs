namespace SwissTransport.Core
{
    ...
    public class Transport : ITransport, IDisposable
    {
        ...
        public StationBoardRoot GetStationBoard(string station, string id, string dateStation, string timeStation)
        {
            ...
            var uri = new Uri($"{WebApiHost}stationboard?station={station}&id={id}&datetime={dateStation} {timeStation}");
